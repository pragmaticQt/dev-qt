if (CMAKE_VERSION VERSION_LESS 3.1.0)
    message(FATAL_ERROR "Qt 5 AppManPluginInterfaces module requires at least CMake version 3.1.0")
endif()
...
set(Qt5AppManPluginInterfaces_VERSION_STRING 5.15.1)
...
function(_qt5_AppManPluginInterfaces_process_prl_file prl_file_location Configuration lib_deps link_flags)
    set(_lib_deps)
    set(_link_flags)

    set(_qt5_install_libs "${_qt5AppManPluginInterfaces_install_prefix}/lib/")
            ...
            elseif(_framework_flag OR _flag MATCHES "^-l(.*)$")
                ...
                elseif(_lib MATCHES "^pthread$")
                    ...
                    if(current_search_paths)
                        find_library(_Qt5AppManPluginInterfaces_${Configuration}_${_lib}_PATH ${_lib} HINTS ${current_search_paths} NO_DEFAULT_PATH)
                    endif()
                    find_library(_Qt5AppManPluginInterfaces_${Configuration}_${_lib}_PATH ${_lib} HINTS ${CMAKE_CXX_IMPLICIT_LINK_DIRECTORIES})
                    mark_as_advanced(_Qt5AppManPluginInterfaces_${Configuration}_${_lib}_PATH)
                    if(_Qt5AppManPluginInterfaces_${Configuration}_${_lib}_PATH)
                        list(APPEND _lib_deps
                            ${_Qt5AppManPluginInterfaces_${Configuration}_${_lib}_PATH}
                        )
                    else()
...
macro(_populate_AppManPluginInterfaces_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set(_deps
        ${_Qt5AppManPluginInterfaces_LIB_DEPENDENCIES}
    )
    set(_static_deps
        ${_Qt5AppManPluginInterfaces_STATIC_${Configuration}_LIB_DEPENDENCIES}
    )
    ...
    set_property(TARGET Qt5::AppManPluginInterfaces APPEND PROPERTY INTERFACE_LINK_LIBRARIES
                 "${_deps}"
    )
    ...
    set(_static_link_flags "${_Qt5AppManPluginInterfaces_STATIC_${Configuration}_LINK_FLAGS}")
    if(_static_link_flags)
        set(_static_link_flags_genex "$<${_genex_condition}:${_static_link_flags}>")
        if(NOT CMAKE_VERSION VERSION_LESS "3.13")
            set_property(TARGET Qt5::AppManPluginInterfaces APPEND PROPERTY INTERFACE_LINK_OPTIONS
    ...
    set(imported_implib "${_qt5AppManPluginInterfaces_install_prefix}/lib/${IMPLIB_LOCATION}")
    _qt5_AppManPluginInterfaces_check_file_exists(${imported_implib})
...
if (NOT TARGET Qt5::AppManPluginInterfaces)
    ...
    set(_Qt5AppManPluginInterfaces_MODULE_DEPENDENCIES "Core")


    set(Qt5AppManPluginInterfaces_OWN_PRIVATE_INCLUDE_DIRS ${Qt5AppManPluginInterfaces_PRIVATE_INCLUDE_DIRS})
    ...
    foreach(_module_dep ${_Qt5AppManPluginInterfaces_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.1 ${_Qt5AppManPluginInterfaces_FIND_VERSION_EXACT}
    ...
    if(TARGET Qt5::AppManPluginInterfaces)
        return()
    endif()

    set(_Qt5AppManPluginInterfaces_LIB_DEPENDENCIES "Qt5::Core")


    if(NOT Qt5_EXCLUDE_STATIC_DEPENDENCIES)
        _qt5_AppManPluginInterfaces_process_prl_file(
            "${_qt5AppManPluginInterfaces_install_prefix}/lib/Qt5AppManPluginInterfacesd.prl" DEBUG
            _Qt5AppManPluginInterfaces_STATIC_DEBUG_LIB_DEPENDENCIES
            _Qt5AppManPluginInterfaces_STATIC_DEBUG_LINK_FLAGS
        )

        _qt5_AppManPluginInterfaces_process_prl_file(
            "${_qt5AppManPluginInterfaces_install_prefix}/lib/Qt5AppManPluginInterfaces.prl" RELEASE
            _Qt5AppManPluginInterfaces_STATIC_RELEASE_LIB_DEPENDENCIES
            _Qt5AppManPluginInterfaces_STATIC_RELEASE_LINK_FLAGS
        )
    endif()
    ...
    set_property(TARGET Qt5::AppManPluginInterfaces PROPERTY INTERFACE_QT_ENABLED_FEATURES )
    set_property(TARGET Qt5::AppManPluginInterfaces PROPERTY INTERFACE_QT_DISABLED_FEATURES )

    # Qt 6 forward compatible properties.
    set_property(TARGET Qt5::AppManPluginInterfaces
    ...
    set_property(TARGET Qt5::AppManPluginInterfaces PROPERTY INTERFACE_QT_PLUGIN_TYPES "")

    set(_Qt5AppManPluginInterfaces_PRIVATE_DIRS_EXIST TRUE)
    foreach (_Qt5AppManPluginInterfaces_PRIVATE_DIR ${Qt5AppManPluginInterfaces_OWN_PRIVATE_INCLUDE_DIRS})
        if (NOT EXISTS ${_Qt5AppManPluginInterfaces_PRIVATE_DIR})
            set(_Qt5AppManPluginInterfaces_PRIVATE_DIRS_EXIST FALSE)
        endif()
    endforeach()

    if (_Qt5AppManPluginInterfaces_PRIVATE_DIRS_EXIST)
        add_library(Qt5::AppManPluginInterfacesPrivate INTERFACE IMPORTED)
        set_property(TARGET Qt5::AppManPluginInterfacesPrivate PROPERTY
            INTERFACE_INCLUDE_DIRECTORIES ${Qt5AppManPluginInterfaces_OWN_PRIVATE_INCLUDE_DIRS}
        )
        set(_Qt5AppManPluginInterfaces_PRIVATEDEPS)
        foreach(dep ${_Qt5AppManPluginInterfaces_LIB_DEPENDENCIES})
            if (TARGET ${dep}Private)
                list(APPEND _Qt5AppManPluginInterfaces_PRIVATEDEPS ${dep}Private)
            endif()
        endforeach()
        set_property(TARGET Qt5::AppManPluginInterfacesPrivate PROPERTY
            INTERFACE_LINK_LIBRARIES Qt5::AppManPluginInterfaces ${_Qt5AppManPluginInterfaces_PRIVATEDEPS}
        )

        # Add a versionless target, for compatibility with Qt6.
        if(NOT "${QT_NO_CREATE_VERSIONLESS_TARGETS}" AND NOT TARGET Qt::AppManPluginInterfacesPrivate)
            add_library(Qt::AppManPluginInterfacesPrivate INTERFACE IMPORTED)
            set_target_properties(Qt::AppManPluginInterfacesPrivate PROPERTIES
                INTERFACE_LINK_LIBRARIES "Qt5::AppManPluginInterfacesPrivate"
            )
        endif()
    endif()

    _populate_AppManPluginInterfaces_target_properties(RELEASE "Qt5AppManPluginInterfaces.lib" "" TRUE)



    _populate_AppManPluginInterfaces_target_properties(DEBUG "Qt5AppManPluginInterfacesd.lib" "" TRUE)
...
# Add a versionless target, for compatibility with Qt6.
if(NOT "${QT_NO_CREATE_VERSIONLESS_TARGETS}" AND TARGET Qt5::AppManPluginInterfaces AND NOT TARGET Qt::AppManPluginInterfaces)
    add_library(Qt::AppManPluginInterfaces INTERFACE IMPORTED)
    set_target_properties(Qt::AppManPluginInterfaces PROPERTIES
        INTERFACE_LINK_LIBRARIES "Qt5::AppManPluginInterfaces"
    )
endif()
